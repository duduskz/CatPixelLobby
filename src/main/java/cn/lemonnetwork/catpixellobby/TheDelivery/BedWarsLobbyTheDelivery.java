...
public class BedWarsLobbyTheDelivery implements CommandExecutor {
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
    ...
    Item item = player.getWorld().dropItem(new Location(player.getWorld(), 15.486D, 70.1D, -6.458D), new ItemStack(Material.DIAMOND));
    ...
    Bukkit.getScheduler().scheduleSyncDelayedTask((Plugin)this.plugin, () -> {
          Item item1 = player.getWorld().dropItem(new Location(player.getWorld(), 15.486D, 70.1D, -6.458D), new ItemStack(Material.EMERALD));
    ...
    Bukkit.getScheduler().scheduleSyncDelayedTask((Plugin)this.plugin, () -> {
          Item item1 = player.getWorld().dropItem(new Location(player.getWorld(), 15.486D, 70.1D, -6.458D), new ItemStack(Material.DIAMOND));
          item1.setMetadata("TheDeliveryCommand", (MetadataValue)new FixedMetadataValue((Plugin)this.plugin, Boolean.valueOf(true)));
          item1.setPickupDelay(2147483647);
          items.add(item1);
        },15L);
